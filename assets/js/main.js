...
const scrollActive = () => {
  ...
  sections.forEach((current) => {
    const sectionHeight = current.offsetHeight,
      sectionTop = current.offsetTop - 58, // Corregido para calcular correctamente la posición superior
    ...
    if (sectionsClass) {
      // Verificar si existe antes de aplicar clases
...
// FOOTER
sr.reveal(".footer__container, .footer__copy");
